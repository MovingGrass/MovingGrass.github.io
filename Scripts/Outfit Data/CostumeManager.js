...
//Stat tracker class to track stats with the outfit equipped
 export class statTracker{
    ...
    setupStatPanel(scene){
        scene.statPanel = scene.add.image(100, 90, 'statPanel').setDisplaySize(300, 200);
        scene.statText = scene.add.text(75, 30, 'Stat:', { fontFamily: 'pixelFont', fontSize: 32, color: '#000000'});
        scene.currentStatText = scene.add.text(85, 80, '0', { fontFamily: 'pixelFont', fontSize: 64, color: '#000000' });
    }
    getStatPoints() {
